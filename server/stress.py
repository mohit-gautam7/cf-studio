    ...
    for it in range(1, iterations + 1):
        ...
        if g.error or g.exit_code != 0 or g.compile_code:
            return {"status": "generator_error", "iteration": it,
                    ...
                    "generator": gen, "brute_source": brute_source}
        test_input = g.stdout
        if not test_input.strip():
            return {"status": "generator_error", "iteration": it,
                    "message": "generator printed empty input", "generator": gen, "brute_source": brute_source}
        ...
        if b.error or b.compile_code or b.exit_code != 0 or b.signal:
            return {"status": "brute_error", "iteration": it,
                    ...
                    "input": test_input[:2000], "brute": brute, "brute_source": brute_source}
        ...
        if u.exit_code != 0:
            return {"status": "mismatch", "iteration": it, "kind": "RE",
                    ...
                    "got": "(runtime error)\n" + (u.stderr or "")[:800], "brute_source": brute_source}
